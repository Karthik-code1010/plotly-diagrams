...
console.log('component data ==>>>>>>',this.data);
  ...
  histogram(){
    ...
    var x1 = [0.002789,0.060789,0.00983,0.82341,0.0023457,0.9672,0.9563,0.8672,0.75675,0.892,1.2,1.3,1.4,3.1,3.2,3.3,3.4,3.9,4,3.6,3.3,3.1,2.9,2.8,2.5];
    var x2 = [0.001239,0.0029,0.00345,0.567,0.5566,0.456,0.678,0.5678,0.678,0.789,0.897,0.5667,0.789,0.678,0.678,0.89,0.898,0.987,0.6785,0.6789,0.9898];
